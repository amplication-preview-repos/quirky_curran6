...
@InputType()
class FlashcardSessionUpdateInput {
  @ApiProperty({
    required: false,
    type: Boolean,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => FlashcardSessionEntryUpdateManyWithoutFlashcardSessionsInput,
  })
  @ValidateNested()
  @Type(() => FlashcardSessionEntryUpdateManyWithoutFlashcardSessionsInput)
  @IsOptional()
  @Field(() => FlashcardSessionEntryUpdateManyWithoutFlashcardSessionsInput, {
    nullable: true,
  })
...
export { FlashcardSessionUpdateInput as FlashcardSessionUpdateInput };
