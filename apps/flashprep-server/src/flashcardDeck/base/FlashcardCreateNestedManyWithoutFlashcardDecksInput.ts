...
@InputType()
class FlashcardCreateNestedManyWithoutFlashcardDecksInput {
...
export { FlashcardCreateNestedManyWithoutFlashcardDecksInput as FlashcardCreateNestedManyWithoutFlashcardDecksInput };
