...
@InputType()
class FlashcardUpdateManyWithoutFlashcardDecksInput {
...
export { FlashcardUpdateManyWithoutFlashcardDecksInput as FlashcardUpdateManyWithoutFlashcardDecksInput };
